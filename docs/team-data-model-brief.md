...
| 대중교통 OD | [서울시 행정동 단위 대중교통 출발지/도착지 승객수 정보](https://data.seoul.go.kr/dataList/OA-21226/F/1/datasetView.do) | 2023-01 ~ 2025-12 | 행정동별/시간별 유입, 유출, 순유입 승객수 생성 | 실제 택시가 아니라 버스/지하철 기반 이동 수요입니다. |
