...
const nextConfig: any = {
  ...
  env: {
    ...
    // 로컬 개발 시 자체 Mock API를 기본으로 사용
    // 실제 백엔드 연결 시 .env.local에서 NEXT_PUBLIC_DEMAND_API_ENDPOINT 를 오버라이드
    NEXT_PUBLIC_DEMAND_API_ENDPOINT:
      envValue("NEXT_PUBLIC_DEMAND_API_ENDPOINT") || "/api/demand",
  },
};
