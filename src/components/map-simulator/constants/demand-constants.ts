...
export const DEMAND_VISUAL_UNIT_CALLS = 40; // 콜 수요 시각화 마커 1개당 proxy 단위
export const DEMAND_VISUAL_MAX_TAXIS = MAX_TAXI_COUNT;
export const TAXI_MARKER_SCALE_MIN_PERCENT = 0.1;
export const TAXI_MARKER_SCALE_MAX_PERCENT = 12;
export const TAXI_MARKER_SCALE_DEFAULT_PERCENT = 0.5;
export const TAXI_MARKER_SCALE_STEP_PERCENT = 0.1;
