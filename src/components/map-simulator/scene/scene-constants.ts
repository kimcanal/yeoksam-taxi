...
export const VEHICLE_SIMULATION_FPS = 60;
...
export const CAMERA_MIN_PITCH = 0.12;
...
export const HOVER_REFRESH_INTERVAL = 1 / 60;
export const LABEL_RENDER_INTERVAL = 1 / 60;
...
export const DRIVE_PIXEL_RATIO = 1.25;
export const FOLLOW_PIXEL_RATIO = 1.25;
export const OVERVIEW_PIXEL_RATIO = 1.35;
