...
import type { NonRoadFeatureCollection } from "@/components/map-simulator/map-simulator-types";
import { shapesOfNonRoadFeature } from "@/components/map-simulator/map-geometry-utils";
import { NON_ROAD_LAYER_Y } from "@/components/map-simulator/scene-constants";
